...
public class InfoService {
    ...
    public InfoRequest getTerms() {
        ...
        InfoRequest infoRequest = restTemplate.getForObject("http://www.worldofanime.com/api/rest/help/terms?oauth_consumer_key=" + oauthConsumerKey + "&oauth_consumer_secret=" + oauthConsumerSecret, InfoRequest.class);
